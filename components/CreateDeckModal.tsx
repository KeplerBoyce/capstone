...
type CreateDeckModalProps = Omit<CenteredModalProps, 'children'> & {callback: (deck: Deck) => void, new: boolean}
            ...
            <div className="relative flex flex-col bg-white rounded-md w-96 max-h-[90%] mx-2 p-6 shadow-xl">
                ...
                <section className="flex flex-col gap-2 mb-2">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <div className="flex flex-col gap-1.5 max-h-72 overflow-auto scrollbar-none">
                            {cards.map((x, i) => (
                                <CardInputGroup 
                                    name="Cards"
                                    index={i}
